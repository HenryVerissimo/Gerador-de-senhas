...
class MyApplication:
    ...
    def main(self, page: ft.Page) -> None:
        ...
        self.__set_actual_view(self._dict_views["menu"])
    ...
    def __register_on_clicks(self):
        self._dict_views["login"].enter_button.on_click=lambda e:go_to_view(e, self.__page, self._dict_views["home"])
        self._dict_views["menu"].home_bar.return_icon.on_click=lambda e:go_to_view(e, self.__page, self._dict_views["home"])
        self._dict_views["menu"].home_bar.menu_icon.on_click=lambda e:go_to_view(e, self.__page, self._dict_views["home"])
